						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#DigitalAssetManagement-display"
								}
							}]
						}]
					}
					...
					"config": {
						"inbounds": {
							"DigitalAssetManagement-display": {
								"semanticObject": "DigitalAssetManagement",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=am.ZDASMGMT",
									"url": sap.ui.require.toUrl("am/ZDASMGMT")
								}
							}
						}
					}
